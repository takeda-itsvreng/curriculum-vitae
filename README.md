...
| 資格 | 応用情報（2010/12） <br> AWS認定ソリューションアーキテクト（2022/11） |
| 英語力 | TOEIC 755点 (2022/7) |

## 現在の状況

2023年1月から参画できる案件をエージェント経由で探し中です。
...
#### 事業会社 2022/10 ～ 2022/12

- 人材系システム移行
  - 役割：メンバ
  - 業務内容：他グループからの会社買収にともなうAWS環境とデータセンタ環境の移行を行う
  - 特記事項：
    - 移行対象システムや外部接続システム、データ連携を明確化して資料を作成
    - 移行イメージ図を作成
    - 各システムのベンダと打ち合わせし、移行設計を推進
---
...
- 各種銀行系システム対応
  ...
  - 特記事項：
    ...
    - FCスイッチのセットアップを実施
      - メンバからいきなりヘルプと言われ、私もあまり経験したことが無かったが、急いでマニュアルを確認して何とか完了
---
